...
public class ShipScript : MonoBehaviour
{
    ...
    public Vector3 GetOffsetVec(Vector3 tilePos)
    {
        ...
        return new Vector3(tilePos.x - 62 + xOffset, 20, tilePos.z -53 + zOffset);  //62 and 47 is how much off the ships are in the new positions
    ...
    {
        ClearTileList();
        transform.localPosition = new Vector3(newVec.x -62 + xOffset, 20, newVec.z -53 + zOffset); 
