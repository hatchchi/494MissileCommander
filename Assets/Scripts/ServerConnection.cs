...
class FireMessage
{
    public string type { get; private set; } = "fire";

    public FireMessagePayload payload { get; set; } = new FireMessagePayload();
}
...
class GameServerConnection
{
    ...
    private static GameServerConnection instance = null;
    ...
    public static GameServerConnection Instance
    {
        get
        {
            if (instance == null)
            {
                instance = new GameServerConnection();
            }
            return instance;
        }
    }

    public void connect(Uri socketServerUri)
    {
